...
# -*- coding: utf-8 -*-
"""
    [*] Description : Suicide Prevention - Personalized Questionnaires
...
from lib.modules.API_google import GoogleAPI, GoogleSheetsAPI
...
class Controller():
    ...
    def run_task1_analyze_results(self):
        ...
        for row_idx, row in tqdm(output_df.iterrows(), desc = "Loading..."):
            ...
            # Step 8: Save results (you can modify this based on your needs)
    ...
    def run_task1_visualize_results(self, save_dir="./results"):
        """
